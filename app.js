...
// Stepper (Kayıt) sistemi için geçici veri deposu
...
styleFix.innerHTML = `
    ...
    .grade-btn, .interest-btn, .purpose-btn { 
        background: #F3F4F6; 
    ...
    .grade-btn.active, .interest-btn.active, .purpose-btn.active { 
    ...
    /* =========================================================
       BİLDİRİM PANELİ ŞABLONU CSS (KÜÇÜK EKRANA UYGUN)
       ========================================================= */
    .notif-compact-panel { 
        max-height: 350px; 
        overflow-y: auto; 
...
// ============================================================================
// 1. GİRİŞ, KAYIT (STEPPER), ONAY VE ŞİFREMİ UNUTTUM
// ============================================================================
...
window.renderStep = function(step) {
    ...
    if (step === 1) {
        html = `
            ...
            <input type="text" id="reg-name" placeholder="Adın" class="form-control" style="margin-bottom:10px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc;">
            <input type="text" id="reg-surname" placeholder="Soyadın" class="form-control" style="margin-bottom:10px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc;">
            <input type="number" id="reg-age" placeholder="Yaşın" class="form-control" style="margin-bottom:10px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc;">
            <input type="email" id="reg-email" placeholder="Okul E-postan" class="form-control" style="margin-bottom:10px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc;">
            <input type="password" id="reg-password" placeholder="Şifren" class="form-control" style="margin-bottom:20px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc;">
            
            <button class="btn-primary" style="width:100%; padding:12px;" onclick="window.processStep(1)">Devam Et →</button>
            <p style="text-align:center; margin-top:15px;">
                <a href="#" onclick="document.getElementById('stepper-wrapper').remove(); document.getElementById('login-card').style.display='block';">Geri Dön</a>
            </p>
        `;
    } else if (step === 2) {
        ...
        html = `
            ...
            <select id="reg-faculty" class="form-control" style="margin-bottom:15px; width:100%; padding:12px; border-radius:10px; border:1px solid #ccc; background:#F3F4F6;">
            ...
            <button class="btn-primary" style="width:100%; padding:12px;" onclick="window.processStep(2)">Devam Et →</button>
        `;
    } else if (step === 3) {
        ...
        html = `
            ...
            <button class="btn-primary" style="width:100%; padding:12px;" onclick="window.processStep(3)">Devam Et →</button>
        `;
    } else if (step === 4) {
        ...
        html = `
            ...
            <button class="btn-primary" style="width:100%; padding:12px;" onclick="window.processStep(4)">Profili Tamamla →</button>
        `;
    } else if (step === 5) {
        html = `
            ...
            <div class="profile-card-preview">
                <div style="position:relative; cursor:pointer;" onclick="document.getElementById('final-avatar-upload').click()">
                    <img src="https://via.placeholder.com/80" id="preview-pc-avatar" class="pc-avatar">
                    <div style="position:absolute; bottom:-5px; right:-5px; background:var(--primary); color:white; border-radius:50%; width:24px; height:24px; display:flex; align-items:center; justify-content:center; font-size:12px; border:2px solid white;">📷</div>
                </div>
                ...
                <div class="pc-info">
                    ...
                    <div class="pc-sub" style="color:var(--primary);">${window.registrationData.faculty}</div>
                    <div class="pc-tags">
            ...
            <button id="final-register-btn" class="btn-primary" style="width:100%; padding:14px; font-size:16px; font-weight:bold;" onclick="window.finalizeRegistration()">Uygulamaya Giriş Yap 🚀</button>
        `;
    }
...
window.previewFinalAvatar = function(event) {
    ...
    if(file) {
        ...
        reader.onload = function(e) { document.getElementById('preview-pc-avatar').src = e.target.result; }
...
window.renderProfile = function() {
    ...
    mainContent.innerHTML = `
        <div class="card" style="padding:20px; min-height: calc(100vh - 120px);">
            ...
            <div class="profile-card-preview" style="flex-direction:column; text-align:center; background:#fff; border:2px solid var(--primary);">
                ${avatarHtml}
